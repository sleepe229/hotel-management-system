...
public class HotelLoggedInController implements Initializable {
    ...
    public MenuItem accept_room_btn;
    public MenuItem cancel_room_btn;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        accept_room_btn.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {

            }
        });
        cancel_room_btn.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
            }
        });
